...
public class Global {
    ...
    static int numberOfColumnsIn_MainReport_and_CandidatesWithMandates_Tables = 6;
    static int numberOfGlobalColumns = numberOfColumnsIn_MainReport_and_CandidatesWithMandates_Tables;
}
